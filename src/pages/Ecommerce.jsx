         ...
         bg-hero-pattern bg-no-repeat bg-center bg-cover'>
          <div className='flex justify-between items-center'>
            <div>
              ...
              <p className='text-2xl'>$75,442.12</p>
            </div>
          </div>
      ...
      <div className='flex m-2 flex-wrap justify-center gap-1 items-center'>
        {
          earningData.map((item)=>(
            <div key={item.title} className='bg-white dark:text-gray-200 dark:bg-secondary-dark-bg  md:w-50 lg:w-56 p-4 pt-9 rounded-2xl'>
              ...
              <p className='mt-3'>
                ...
                <span className={`text-sm
                 ${parseInt(item.percentage.substring(0,item.percentage.indexOf('%'))) > 0 ? 'text-green-600' : 'text-red-600'}
                  ml-2`}
                  >
                  {item.percentage}
                </span>
          ...
          <div className='mt-10 flex gap-10 flex-wrap justify-center'>
            ...
            <div className='border-r-1 border-color m-4 pr-10'>
              <div className='flex items-center gap-4'>
                ...
                <p className='flex items-center gap-2 hover:drop-shadow-xl' style={{color:"#50C878"}}>
                <span><GoPrimitiveDot/></span>
                <span>Budget</span>
                </p>
              </div>
            ...
            <div>
              <Pie id="chart-pie" data={pieChartData} legendVisiblity height="400px" />
            </div>
